...
if (isset($_GET['addtocart'])) {
    ...
    $price = $_GET['price'];
    if (!empty($Dprice)) {
        $tprice = intval($num) * intval($Dprice);
    } else {
    ...
    if (!empty($Error)) {
        ...
        mysqli_stmt_bind_param($stmt, 'sssis',$pid, $uid, $num, $tprice, $Pstatus);
...
<body>
    ...
    <section class="product_detail">
        ...
        <div class="review_pro">
            <form action="productdetail.php?pid=<?php echo $pid; ?>" style="padding-left:20px; border:none;" class="login_form" method="GET">
