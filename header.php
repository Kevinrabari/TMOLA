...
<div class="Header">
    ...
    <span class="nav_btn">
        <div class="search" action="Search.php">
            <input type="text" height="70px" width="50px" class="search_input" name="search_input">
            <button class="searchbtn" for="Search_input" name="search" value="Search">Search</button>
        </div>
        <div class="Home">
            <button class="dropbtn"><a href="index.php">Home</a></button>
        </div>
            ...
            <?php if ($Status == true) { ?>
                <div class="dropdown">
                    <button class="dropbtn">
                        <img src="Assets/Icons/Profile.png" alt="Profile icon" class="Header_icon" height="50px"
                            width="50px">
                    </button>
                    <div class="dropdown-content">
