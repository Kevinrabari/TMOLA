...
<div class="tab">
  ...
  <button class="tablinks" onclick="openCity(event, 'Order')">Order items</button>
...
<th></th>
    ...
    foreach ($admin as $r) {
      ...
      echo "<td>" . $r['userCity'] . "</td>";
      echo "<td>" . $r['userPostalcode'] . "</td>";
      // echo "<td><div class='clearfix'><button type='submit'  class='login_submit' name='update' value='update'>Update</button></div></td>";
      echo "<td><div class='clearfix_button'><a href='order_delete.php?id=".$r['productId']."'>Delete</a></div></td>";
      echo "</tr>";
    }
    echo "
        </table>";
