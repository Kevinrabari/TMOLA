...
function order_detail($id)
{
    ...
    $sql = "SELECT product_master.ProductImages1, product_master.productName, product_master.productModel, product_master.productPrice, product_master.discountPrice,  order_item.orderTotalpayment, order_item.orderQuantity, order_item.orderId from order_item join product_master on product_master.productId = order_item.productId where orderId=$id;";
    $result = mysqli_query($conn, $sql);
    $result = mysqli_query($conn, $sql);
    if (!$result) {
    ...
    $order_detail = array($product_img, $product_name, $product_model, $product_quantity, $product_price, $product_dprice, $product_total, $orderid);
    return $order_detail;
}
    ...
    <section class="cart_page">
        <div class="more_info">
                    ...
                    <table style="border:2px; width:100%;">
                        ...
                        foreach ($oid as $id) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <label>
                                        ...
                                        if (!empty($m[5])) {
                                            ...
                                            $dp = number_format((100 * $d) / intval($m[4]), 2);
                                            echo $dp . "%";
                                        } else {
                                            echo "0%";
                                        } ?>
                                ...
                                <td>
                                    <a href="Productdetail.php?pid=<?php echo $m[7]; ?>&q=<?php echo $m[3]; ?>">View
                                        product</a>
                                </td>
                            </tr>
                        <?php }
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="tablinks" onclick="tabname(event, 'Checkout')"
                                    id="cart_button">Checkout</button>
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div id="Checkout" class="tabcontent">
                ...
                <div>
                    <p>
                        <button class="tablinks" onclick="tabname(event, 'Cartsummary')" id="cart_button"
                            style="background-color: red;">Modify</button><br>
                    </p>
                    <table style="border:2px; width:100%;">
                        <tr>
                            <th>Quntity</th>
                        ...
                        <tr style="background-color:white;">
                            ...
                            <td>
                                ...
                                ?>
                                <input type="Radio" id="Free" name="Delivery_option" value="FREE"
                                    onchange="myFunction(this.value,'<?php echo $gtotal; ?>')" checked>
                                <label for="Free"> Regular: Free Delivery </label><br>
                                <input type="Radio" id="Fast" name="Delivery_option" value="20"
                                    onchange="myFunction(this.value,'<?php echo $gtotal; ?>')">
                                <label for="Fast"> Fast Delivery: $20 </label><br>
                                <input type="Radio" id="Pickup" name="Delivery_option" value="0"
                                    onchange="myFunction(this.value,'<?php echo $gtotal; ?>')">
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="tablinks" onclick="tabname(event, 'Address')" id="cart_button">Choose
                                    your Address</button>
                            </td>
                        </tr>
                    </table>
            ...
            <div id="Address" class="tabcontent">
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <label for="add_radio">
                                ...
                                <span style="margin-left: 30px;"><strong> Phone
                                        No:</strong>
                                    <?php echo $Pinfo['userTelephone']; ?>
                                </span><br>
                                <span style="margin-left: 30px;"><strong>
                                        Email:</strong>
                                    <?php echo $Pinfo['userEmail']; ?><br>
                                    <address style="margin-left: 30px;">
                                        <strong>Address:</strong>
                                        <?php echo $Pinfo['userAddress']; ?><br>
                                        <span style="margin-left: 80px;">
                                            <?php echo $Pinfo['userCity']; ?>
                                        </span><br>
                    ...
                    <tr>
                        <td>
                            <a href="Profile.php" style="text-decoration: none;"><strong>Modify your
                                    address</strong></a>
                        </td>
                        <td>
                            <button class="tablinks" id="cart_button"
                                onclick="tabname(event, 'Summary')">Summary</button>
                        </td>
                    </tr>
                </table>
                    ...
                    <div>
                        <table style="border:2px; width:100%;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="tablinks" onclick="tabname(event, 'Thankyou')" id="cart_button">Place
                                        order</button>
                                </td>
                            </tr>
